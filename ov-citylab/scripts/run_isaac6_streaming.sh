...
docker run -d --name "$NAME" \
  ...
  -e CITYLAB_VIEWPORT_HTTP="${CITYLAB_VIEWPORT_HTTP:-1}" \
  -e CITYLAB_VIEWPORT_CAPTURE_EVERY="${CITYLAB_VIEWPORT_CAPTURE_EVERY:-2}" \
  -e CITYLAB_VIEWPORT_JPEG_MAX_W="${CITYLAB_VIEWPORT_JPEG_MAX_W:-640}" \
  -e CITYLAB_VIEWPORT_JPEG_QUALITY="${CITYLAB_VIEWPORT_JPEG_QUALITY:-50}" \
  -e CITYLAB_SUMO="${CITYLAB_SUMO:-1}" \
  -e CITYLAB_SUMO_DEFER="${CITYLAB_SUMO_DEFER:-1}" \
  -e CITYLAB_SUMO_WALL_CLOCK="${CITYLAB_SUMO_WALL_CLOCK:-1}" \
  -e CITYLAB_SUMO_REALTIME="${CITYLAB_SUMO_REALTIME:-1.0}" \
  -e CITYLAB_SUMO_MAX_STEPS="${CITYLAB_SUMO_MAX_STEPS:-2}" \
  -e CITYLAB_CAR_YAW_OFFSET="${CITYLAB_CAR_YAW_OFFSET:-180}" \
  -e CITYLAB_PED_YAW_OFFSET="${CITYLAB_PED_YAW_OFFSET:-180}" \
  -e CITYLAB_ROBOT_YAW_OFFSET="${CITYLAB_ROBOT_YAW_OFFSET:-90}" \
  ...
  -e CITYLAB_PED_MODEL="${CITYLAB_PED_MODEL:-jupedsim}" \
  -e CITYLAB_MAX_PED="${CITYLAB_MAX_PED:-16}" \
